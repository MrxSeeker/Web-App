...
export class UserLoginService {
  readUser(_id: string) {
    ...
    return this.http.get<User>(UserLoginService.userHost + "users/" + _id);
  }

  readUsers(): Observable<User[]> {
    return this.http.get<User[]>(UserLoginService.userHost + "users/");
  }
  ...
  profile() {
    this.http.get(UserLoginService.userHost + 'user/_id')
  }
}
